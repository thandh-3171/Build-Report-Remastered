...
#if UNITY_EDITOR
using BuildReportRemastered;
using BuildReportRemastered.Window;
using System;
...
public class BRT_BuildReportWindow : EditorWindow
{
    ...
    void OnEnable()
    {
        ...
        if (BuildReportRemastered.Util.BuildInfoHasContents(_buildInfo))
        {
            //Debug.Log("recompiled " + _buildInfo.SavedPath);
            if (!string.IsNullOrEmpty(_buildInfo.SavedPath))
            {
                BuildReportRemastered.BuildInfo loadedBuild = BuildReportRemastered.Util.OpenSerializedBuildInfo(_buildInfo.SavedPath);
                if (BuildReportRemastered.Util.BuildInfoHasContents(loadedBuild))
                {
            ...
            else
            {
                if (_buildInfo.HasUsedAssets)
                {
                    _buildInfo.UsedAssets.AssignPerCategoryList(
                        BuildReportRemastered.ReportGenerator.SegregateAssetSizesPerCategory(_buildInfo.UsedAssets.All,
                ...
                if (_buildInfo.HasUnusedAssets)
                {
                    _buildInfo.UnusedAssets.AssignPerCategoryList(
                        BuildReportRemastered.ReportGenerator.SegregateAssetSizesPerCategory(_buildInfo.UnusedAssets.All,
                            _buildInfo.FileFilters));
                }
            }
        }

        _usedAssetsScreen.SetListToDisplay(BuildReportRemastered.Window.Screen.AssetList.ListToDisplay.UsedAssets);
        _unusedAssetsScreen.SetListToDisplay(BuildReportRemastered.Window.Screen.AssetList.ListToDisplay.UnusedAssets);
    ...
    void OnInspectorUpdate()
    {
        ...
        if (_buildInfo != null && BuildReportRemastered.ReportGenerator.IsFinishedGettingValues)
        {
        ...
        if (BuildReportRemastered.Util.ShouldGetBuildReportNow &&
            !BuildReportRemastered.ReportGenerator.IsStillGettingValues &&
    ...
    readonly BuildReportRemastered.Window.Screen.Overview _overviewScreen = new BuildReportRemastered.Window.Screen.Overview();

    readonly BuildReportRemastered.Window.Screen.BuildSettings _buildSettingsScreen =
        new BuildReportRemastered.Window.Screen.BuildSettings();

    readonly BuildReportRemastered.Window.Screen.BuildStepsScreen _buildStepsScreen =
        new BuildReportRemastered.Window.Screen.BuildStepsScreen();

    readonly BuildReportRemastered.Window.Screen.SizeStats _sizeStatsScreen = new BuildReportRemastered.Window.Screen.SizeStats();
    readonly BuildReportRemastered.Window.Screen.AssetList _usedAssetsScreen = new BuildReportRemastered.Window.Screen.AssetList();
    readonly BuildReportRemastered.Window.Screen.AssetList _unusedAssetsScreen = new BuildReportRemastered.Window.Screen.AssetList();

    readonly BuildReportRemastered.Window.Screen.Options _optionsScreen = new BuildReportRemastered.Window.Screen.Options();
    readonly BuildReportRemastered.Window.Screen.Help _helpScreen = new BuildReportRemastered.Window.Screen.Help();
    ...
    /// </summary>
    static BuildReportRemastered.BuildInfo _buildInfo;

    /// <summary>
    /// The Asset Dependencies data being used
    /// for whichever Build Report is displayed.
    /// </summary>
    static BuildReportRemastered.AssetDependencies _assetDependencies;

    /// <summary>
    /// The TextureData being used
    /// for whichever Build Report is displayed.
    /// </summary>
    static BuildReportRemastered.TextureData _textureData;

    /// <summary>
    /// The MeshData being used
    /// for whichever Build Report is displayed.
    /// </summary>
    static BuildReportRemastered.MeshData _meshData;

    static BuildReportRemastered.UnityBuildReport _unityBuildReport;
        ...
        BuildInfo buildReportToDisplay, AssetDependencies assetDependencies)
    {
        ...
        if (BuildReportRemastered.Options.ShowAssetPrimaryUsersInTooltipIfAvailable && !alreadyUsingSameAssetPath)
        {
    ...
    {
        BuildReportRemastered.AssetDependencies.PopulateAssetEndUsers(HoveredAssetEntryPath, assetDependencies);
    }
    ...
    void RecategorizeDisplayedBuildInfo()
    {
        if (BuildReportRemastered.Util.BuildInfoHasContents(_buildInfo))
        {
            BuildReportRemastered.ReportGenerator.RecategorizeAssetList(_buildInfo);
        }
    }
    ...
    void InitGUISkin()
    {
        ...
        {
            guiSkinToUse = BuildReportRemastered.Window.Settings.DARK_GUI_SKIN_FILENAME;
        }
        else
        {
            guiSkinToUse = BuildReportRemastered.Window.Settings.DEFAULT_GUI_SKIN_FILENAME;
        }

        // try default path
        _usedSkin = AssetDatabase.LoadAssetAtPath(
                        string.Format("{0}/GUI/{1}", BuildReportRemastered.Options.BUILD_REPORT_TOOL_DEFAULT_PATH, guiSkinToUse),
        ...
        if (_usedSkin == null)
        {
            ...
            string folderPath = BuildReportRemastered.Util.FindAssetFolder(Application.dataPath,
                BuildReportRemastered.Options.BUILD_REPORT_TOOL_DEFAULT_FOLDER_NAME);
            ...
            {
                Debug.LogError(BuildReportRemastered.Options.BUILD_REPORT_PACKAGE_MISSING_MSG);
            }
    ...
    public void Init(BuildReportRemastered.BuildInfo buildInfo)
    {
    ...
    {
        GoToOverviewScreen();
        BuildReportRemastered.ReportGenerator.RefreshData(fromBuild, ref _buildInfo, ref _assetDependencies, ref _textureData, ref _meshData);
    }

    bool IsWaitingForBuildCompletionToGenerateBuildReport
    {
        get { return BuildReportRemastered.Util.ShouldGetBuildReportNow && EditorApplication.isCompiling; }
    }
    ...
    {
        BuildReportRemastered.ReportGenerator.OnFinishedGetValues(_buildInfo, _assetDependencies, _textureData, _meshData);
    ...
    void _OpenBuildInfo(string filepath)
    {
        ...
        BuildReportRemastered.BuildInfo loadedBuild = BuildReportRemastered.Util.OpenSerializedBuildInfo(filepath, false);
        ...
        var assetDependenciesFilePath = BuildReportRemastered.Util.GetAssetDependenciesFilenameFromBuildInfo(filepath);
        if (System.IO.File.Exists(assetDependenciesFilePath))
        {
            var loadedAssetDependencies = BuildReportRemastered.Util.OpenSerialized<BuildReportRemastered.AssetDependencies>(assetDependenciesFilePath);
        ...
        var textureDataFilePath = BuildReportRemastered.Util.GetTextureDataFilenameFromBuildInfo(filepath);
        if (System.IO.File.Exists(textureDataFilePath))
        {
            var loadedTextureData = BuildReportRemastered.Util.OpenSerialized<BuildReportRemastered.TextureData>(textureDataFilePath);
        ...
        var meshDataFilePath = BuildReportRemastered.Util.GetMeshDataFilenameFromBuildInfo(filepath);
        if (System.IO.File.Exists(meshDataFilePath))
        {
            var loadedMeshData = BuildReportRemastered.Util.OpenSerialized<BuildReportRemastered.MeshData>(meshDataFilePath);
        ...
        var unityBuildReportFilePath = BuildReportRemastered.Util.GetUnityBuildReportFilenameFromBuildInfo(filepath);
        if (System.IO.File.Exists(unityBuildReportFilePath))
        {
            var loadedUnityBuildReport = BuildReportRemastered.Util.OpenSerialized<BuildReportRemastered.UnityBuildReport>(unityBuildReportFilePath);
    ...
    void OpenBuildInfoInBackgroundIfNeeded(string filepath)
    {
        ...
        if (!BuildReportRemastered.Options.UseThreadedFileLoading)
        {
    ...
    void DrawTopRowButtons()
    {
        ...
        var leftToolbarStyle = GUI.skin.FindStyle(BuildReportRemastered.Window.Settings.TOOLBAR_LEFT_STYLE_NAME);
        if (leftToolbarStyle == null)
        {
            leftToolbarStyle = GUI.skin.button;
        }

        var midToolbarStyle = GUI.skin.FindStyle(BuildReportRemastered.Window.Settings.TOOLBAR_MIDDLE_STYLE_NAME);
        if (midToolbarStyle == null)
        {
            midToolbarStyle = GUI.skin.button;
        }

        var rightToolbarStyle = GUI.skin.FindStyle(BuildReportRemastered.Window.Settings.TOOLBAR_RIGHT_STYLE_NAME);
            ...
            !LoadingValuesFromThread)
        {
            string filepath = EditorUtility.OpenFilePanel(
                ...
                BuildReportRemastered.Options.BuildReportSavePath,
                "xml");
        ...
        if (GUI.Button(new Rect(toolbarX, 5, 40, 40), _toolbarLabelSave, rightToolbarStyle) &&
            BuildReportRemastered.Util.BuildInfoHasContents(_buildInfo))
        {
            ...
            if (!string.IsNullOrEmpty(filepath))
            {
                BuildReportRemastered.Util.Serialize(_buildInfo, filepath);

                if (_assetDependencies != null && _assetDependencies.HasContents)
                {
                    var assetDependenciesFilePath = BuildReportRemastered.Util.GetAssetDependenciesFilenameFromBuildInfo(filepath);
                    BuildReportRemastered.Util.Serialize(_assetDependencies, assetDependenciesFilePath);
                }

                if (_textureData != null && _textureData.HasContents)
                {
                    var textureDataFilePath = BuildReportRemastered.Util.GetTextureDataFilenameFromBuildInfo(filepath);
                    BuildReportRemastered.Util.Serialize(_textureData, textureDataFilePath);
                }

                if (_meshData != null && _meshData.HasContents)
                {
                    var meshDataFilePath = BuildReportRemastered.Util.GetMeshDataFilenameFromBuildInfo(filepath);
                    BuildReportRemastered.Util.Serialize(_meshData, meshDataFilePath);
                }

                if (_unityBuildReport != null)
                {
                    var unityBuildReportFilePath = BuildReportRemastered.Util.GetUnityBuildReportFilenameFromBuildInfo(filepath);
                    BuildReportRemastered.Util.Serialize(_unityBuildReport, unityBuildReportFilePath);
                }
            }
        }
        ...
        if (GUI.Button(new Rect(toolbarX, 5, 55, 40), _toolbarLabelOptions, leftToolbarStyle))
        {
            ...
            BuildReportRemastered.Options.UpdatePreviousSearchType();
        }
    ...
    void OnGUI()
    {
        if (Event.current.type == EventType.Layout)
        {
            ...
            _buildInfoHasNoContentsToDisplay = !BuildReportRemastered.Util.BuildInfoHasContents(_buildInfo);
        }
        ...
        {
            GUI.Label(new Rect(300, -25, 500, 100), BuildReportRemastered.Options.BUILD_REPORT_GUI_SKIN_MISSING_MSG);
        }

        DrawTopRowButtons();

        if (GUI.skin.FindStyle(BuildReportRemastered.Window.Settings.VERSION_STYLE_NAME) != null)
        {
            GUI.Label(new Rect(0, 0, position.width, 20), BuildReportRemastered.Info.ReadableVersion,
                BuildReportRemastered.Window.Settings.VERSION_STYLE_NAME);
        }
        else
        {
            GUI.Label(new Rect(position.width - 160, 0, position.width, 20), BuildReportRemastered.Info.ReadableVersion);
        }
        ...
        var leftTabStyle = GUI.skin.FindStyle(BuildReportRemastered.Window.Settings.TAB_LEFT_STYLE_NAME);
        if (leftTabStyle == null)
        {
            leftTabStyle = GUI.skin.button;
        }

        var midTabStyle = GUI.skin.FindStyle(BuildReportRemastered.Window.Settings.TAB_MIDDLE_STYLE_NAME);
        if (midTabStyle == null)
        {
            midTabStyle = GUI.skin.button;
        }

        var rightTabStyle = GUI.skin.FindStyle(BuildReportRemastered.Window.Settings.TAB_RIGHT_STYLE_NAME);
        ...
        {
            if (_selectedCategoryIdx != USED_ASSETS_IDX && BuildReportRemastered.Options.HasSearchTypeChanged)
            {
        ...
        {
            if (_selectedCategoryIdx != UNUSED_ASSETS_IDX && BuildReportRemastered.Options.HasSearchTypeChanged)
            {
        ...
        if (oldSelectedCategoryIdx != OPTIONS_IDX && _selectedCategoryIdx == OPTIONS_IDX)
        {
            ...
            _fileFilterGroupToUseOnOpeningOptionsWindow = BuildReportRemastered.Options.FilterToUseInt;
        }
        else if (oldSelectedCategoryIdx == OPTIONS_IDX && _selectedCategoryIdx != OPTIONS_IDX)
        {
            // moving away from the options screen
            _fileFilterGroupToUseOnClosingOptionsWindow = BuildReportRemastered.Options.FilterToUseInt;
    ...
    public static Vector2 GetThumbnailSize()
    {
        ...
        thumbnailSize.x = ZoomedInThumbnails
                              ? BuildReportRemastered.Options.TooltipThumbnailZoomedInWidth
                              : BuildReportRemastered.Options.TooltipThumbnailWidth;

        thumbnailSize.y = ZoomedInThumbnails
                              ? BuildReportRemastered.Options.TooltipThumbnailZoomedInHeight
                              : BuildReportRemastered.Options.TooltipThumbnailHeight;
    ...
    public static void DrawThumbnailTooltip(Rect position, BuildReportRemastered.TextureData textureData)
    {
    ...
    static bool GetTextureDataForTooltip(string assetPath, BuildReportRemastered.TextureData textureData, out Vector2 labelSize)
    {
        if (textureData == null)
        {
    ...
    public static void DrawThumbnailTooltip(Rect position, string assetPath, Rect assetRect, BuildReportRemastered.TextureData textureData)
    {
    ...
    public static void DrawThumbnailEndUsersTooltip(Rect position, AssetDependencies assetDependencies, BuildReportRemastered.TextureData textureData)
    {
        List<GUIContent> endUsersListToUse = GetEndUserLabelsFor(assetDependencies, HoveredAssetEntryPath);
    ...
    public static void DrawThumbnailEndUsersTooltip(Rect position, string assetPath, GUIContent label,
        List<GUIContent> endUsers, Rect assetRect, BuildReportRemastered.TextureData textureData)
    {
        var thumbnailImage = BRT_BuildReportWindow.GetAssetPreview(assetPath);
