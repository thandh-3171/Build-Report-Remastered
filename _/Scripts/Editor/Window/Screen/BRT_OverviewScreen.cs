...
namespace BuildReportRemastered.Window.Screen
{
    public class Overview : BaseScreen
    {
        ...
        )
        {
            ...
            var titleStyle = GUI.skin.FindStyle(BuildReportRemastered.Window.Settings.MAIN_TITLE_STYLE_NAME);
            if (titleStyle == null)
            {
                titleStyle = GUI.skin.label;
            }

            var bigLabelStyle = GUI.skin.FindStyle(BuildReportRemastered.Window.Settings.INFO_TITLE_STYLE_NAME);
            if (bigLabelStyle == null)
            {
                bigLabelStyle = GUI.skin.label;
            }

            var bigValueStyle = GUI.skin.FindStyle(BuildReportRemastered.Window.Settings.INFO_SUBTITLE_STYLE_NAME);
            if (bigValueStyle == null)
            {
                bigValueStyle = GUI.skin.label;
            }

            var bigNumberStyle = GUI.skin.FindStyle(BuildReportRemastered.Window.Settings.BIG_NUMBER_STYLE_NAME);
            if (bigNumberStyle == null)
            {
                bigNumberStyle = GUI.skin.label;
            }

            var smallLabelStyle = GUI.skin.FindStyle(BuildReportRemastered.Window.Settings.SETTING_NAME_STYLE_NAME);
            if (smallLabelStyle == null)
            {
                smallLabelStyle = GUI.skin.label;
            }

            var smallValueStyle = GUI.skin.FindStyle(BuildReportRemastered.Window.Settings.SETTING_VALUE_STYLE_NAME);
            if (smallValueStyle == null)
            {
                smallValueStyle = GUI.skin.label;
            }

            var helpDescriptionStyle = GUI.skin.FindStyle(BuildReportRemastered.Window.Settings.TINY_HELP_STYLE_NAME);
            if (helpDescriptionStyle == null)
            {
                helpDescriptionStyle = GUI.skin.label;
            }

            var infoDescriptionStyle = GUI.skin.FindStyle(BuildReportRemastered.Window.Settings.INFO_TEXT_STYLE_NAME);
                ...
                !string.IsNullOrEmpty(buildReportToDisplay.BuildFilePath))
            {
                ...
                GUILayout.Label(BuildReportRemastered.Util.GetBuildSizePathDescription(buildReportToDisplay), helpDescriptionStyle);
            ...
            var showThumbnailNow = BuildReportRemastered.Options.ShowTooltipThumbnail &&
        ...
        void DrawAssetList(BuildReportRemastered.AssetList assetList, bool usedAssets, BuildInfo buildReportToDisplay,
            AssetDependencies assetDependencies)
        {
            ...
            BuildReportRemastered.SizePart[] assetsToShow = assetList.TopLargest;
            ...
            var listNormalStyle = GUI.skin.FindStyle(BuildReportRemastered.Window.Settings.LIST_NORMAL_STYLE_NAME);
            if (listNormalStyle == null)
            {
                listNormalStyle = GUI.skin.label;
            }

            var listAltStyle = GUI.skin.FindStyle(BuildReportRemastered.Window.Settings.LIST_NORMAL_ALT_STYLE_NAME);
            if (listAltStyle == null)
            {
                listAltStyle = GUI.skin.label;
            }

            var listIconNormalStyle = GUI.skin.FindStyle(BuildReportRemastered.Window.Settings.LIST_ICON_STYLE_NAME);
            if (listIconNormalStyle == null)
            {
                listIconNormalStyle = GUI.skin.label;
            }

            var listIconAltStyle = GUI.skin.FindStyle(BuildReportRemastered.Window.Settings.LIST_ICON_ALT_STYLE_NAME);
            ...
            BuildReportRemastered.SizePart newEntryHovered = null;
            ...
            {
                BuildReportRemastered.SizePart b = assetsToShow[n];
                ...
                string prettyName = string.Format(" {0}. {1}", (n + 1).ToString(), BuildReportRemastered.Util.GetAssetFilename(b.Name));
            ...
            if (Event.current.type == EventType.Repaint)
            {
                ...
                if (newEntryHoveredIdx != -1)
                {
                    ...
                    if (BuildReportRemastered.Options.ShowTooltipThumbnail &&
                        (BuildReportRemastered.Options.ShowThumbnailOnHoverLabelToo || hoveringOverIcon) &&
            ...
            var useRawSize = (usedAssets && !BuildReportRemastered.Options.ShowImportedSizeForUsedAssets) || !usedAssets;
        ...
        void DrawScenesInBuild(BuildReportRemastered.BuildInfo.SceneInBuild[] scenesInBuild)
        {
            ...
            for (int n = 0; n < scenesInBuild.Length; ++n)
            {
                ...
                if (string.IsNullOrEmpty(scenesInBuild[n].Path))
                {
                    prettyName = string.Format("<color=#{0}><i>Missing</i></color>",
                        BuildReportRemastered.Window.Screen.AssetList.GetPathColor(false));
                }
                else
                {
                    var pathName = BuildReportRemastered.Util.GetAssetPath(scenesInBuild[n].Path);
