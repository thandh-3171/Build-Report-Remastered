...
namespace BuildReportRemastered.Window.Screen
{
    public class SizeStats : BaseScreen
    {
        ...
        )
        {
            ...
            GUILayout.Space(BuildReportRemastered.Window.Settings.CATEGORY_HORIZONTAL_SPACING);
        ...
        void DrawTotalSize(BuildReportRemastered.BuildInfo buildReportToDisplay)
        {
            GUILayout.BeginVertical();
            ...
            if (buildReportToDisplay.HasOldSizeValues)
            {
                ...
                BuildReportRemastered.Window.Utility.DrawLargeSizeDisplay(Labels.USED_TOTAL_SIZE_LABEL,
                    Labels.USED_TOTAL_SIZE_DESC, buildReportToDisplay.TotalBuildSize);
                GUILayout.Space(40);
                BuildReportRemastered.Window.Utility.DrawLargeSizeDisplay(Labels.BUILD_TOTAL_SIZE_LABEL,
                    BuildReportRemastered.Window.Utility.GetProperBuildSizeDesc(buildReportToDisplay),
            ...
            else
            {
                ...
                if (_hasTotalBuildSize)
                {
                    ...
                    GUILayout.Label(BuildReportRemastered.Util.GetBuildSizePathDescription(buildReportToDisplay),
                        descStyle);
                ...
                {
                    BuildReportRemastered.Window.Utility.DrawLargeSizeDisplay(Labels.UNUSED_TOTAL_SIZE_LABEL,
        ...
        void DrawAuxiliaryBuildSizes(BuildReportRemastered.BuildInfo buildReportToDisplay)
        {
            ...
            var medLabelStyle = GUI.skin.FindStyle(BuildReportRemastered.Window.Settings.INFO_SUBTITLE_BOLD_STYLE_NAME);
            ...
            if (buildPlatform == BuildReportRemastered.BuildPlatform.Web)
            {
                GUILayout.Space(20);
                GUILayout.BeginVertical();
            ...
            else if (buildPlatform == BuildReportRemastered.BuildPlatform.Android)
            {
            ...
            {
                GUILayout.Space(20);
                BuildReportRemastered.Window.Utility.DrawLargeSizeDisplay(Labels.STREAMING_ASSETS_TOTAL_SIZE_LABEL,
                    Labels.STREAMING_ASSETS_SIZE_DESC, buildReportToDisplay.StreamingAssetsSize);
            }
        }


        void DrawBuildSizes(BuildReportRemastered.BuildInfo buildReportToDisplay)
        {
            ...
            var labelStyle = GUI.skin.FindStyle(BuildReportRemastered.Window.Settings.INFO_SUBTITLE_STYLE_NAME);
            if (labelStyle == null)
            {
        ...
        void DrawDLLList(BuildReportRemastered.BuildInfo buildReportToDisplay)
        {
            BuildReportRemastered.BuildPlatform buildPlatform =
                BuildReportRemastered.ReportGenerator.GetBuildPlatformFromString(buildReportToDisplay.BuildType,
                    buildReportToDisplay.BuildTargetUsed);
        ...
        void DrawScriptDLLsList(BuildReportRemastered.BuildInfo buildReportToDisplay,
            BuildReportRemastered.BuildPlatform buildPlatform)
        {
        ...
        void DrawNames(BuildReportRemastered.SizePart[] list)
        {
            if (list == null)
            {
                return;
            ...
            GUILayout.BeginVertical();
            bool useAlt = false;
            foreach (BuildReportRemastered.SizePart b in list)
            {
        ...
        void DrawReadableSizes(BuildReportRemastered.SizePart[] list)
        {
            if (list == null)
            {
                return;
        ...
        void DrawPercentages(BuildReportRemastered.SizePart[] list)
        {
            if (list == null)
            {
                return;
