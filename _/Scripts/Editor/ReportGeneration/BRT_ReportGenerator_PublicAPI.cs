...
namespace BuildReportRemastered
{
    public partial class ReportGenerator
    {
        ...
        {
            BuildReportRemastered.Util.SaveBuildTime();
        }
        ...
        {
            BuildReportRemastered.Util.BuildTargetOfLastBuild = buildTarget;

            var editorLogPathToUse = !string.IsNullOrEmpty(customEditorLogPath)
                                         ? customEditorLogPath
                                         : BuildReportRemastered.Util.UsedEditorLogPath;
            ...
            if (BuildReportRemastered.Util.HasBuildTime())
            {
            ...
            if (BuildReportRemastered.Options.CalculateAssetDependencies)
            {
                ...
                {
                    _lastKnownAssetDependencies = new BuildReportRemastered.AssetDependencies();
                }
            ...
            if (BuildReportRemastered.Options.CollectTextureImportSettings)
            {
                ...
                {
                    _lastKnownTextureData = new BuildReportRemastered.TextureData();
                }
            ...
            if (BuildReportRemastered.Options.CollectMeshData)
            {
                ...
                {
                    _lastKnownMeshData = new BuildReportRemastered.MeshData();
                }
