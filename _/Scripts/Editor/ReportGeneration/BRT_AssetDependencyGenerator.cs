...
namespace BuildReportRemastered
{
    ...
    public static class AssetDependencyGenerator
    {
        ...
        public static void Create(AssetDependencies data, BuildReportRemastered.BuildInfo.SceneInBuild[] scenes,
            bool debugLog = false)
        {
            var startingOpenSet = new Queue<string>();
        ...
        public static void CreateForUsedAssetsOnly(AssetDependencies data, BuildReportRemastered.BuildInfo buildInfo,
            bool debugLog = false)
        {
            if (buildInfo == null)
            {
        ...
        public static void CreateForAllAssets(AssetDependencies data, BuildReportRemastered.BuildInfo buildInfo,
            bool debugLog = false)
        {
            if (buildInfo == null)
            {
