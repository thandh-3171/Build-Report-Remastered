...
namespace BuildReportRemastered
{
 ...
 PlayerSettings.bundleIdentifier; // ("Bundle Identifier" in iOS, "Package Identifier" in Android)
        ...
        static void PopulatePackageList(string manifestJsonText, string packagesLockJsonText,
            List<BuildReportRemastered.UnityBuildSettings.PackageEntry> packageList, List<BuildReportRemastered.UnityBuildSettings.BuiltInPackageEntry> builtInPackageList)
        {
            ...
            if (manifest.ContainsKey("dependencies"))
            {
                ...
                if (dependencies != null)
                {
                    ...
                    foreach (var pair in dependencies)
                    {
                        ...
                        {
                            BuildReportRemastered.UnityBuildSettings.BuiltInPackageEntry newBuiltInEntry;
                        ...
                        BuildReportRemastered.UnityBuildSettings.PackageEntry newEntry;
        ...
        static string GetPackageCachePath(BuildReportRemastered.UnityBuildSettings.PackageEntry entry, string projectPackagesCachePath)
        {
