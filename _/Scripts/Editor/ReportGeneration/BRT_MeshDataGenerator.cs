...
namespace BuildReportRemastered
{
    ...
    {
        public static void CreateForUsedAssetsOnly(MeshData data, BuildReportRemastered.BuildInfo buildInfo, bool debugLog = false)
        {
            if (buildInfo == null)
            {
        ...
        public static void CreateForAllAssets(MeshData data, BuildReportRemastered.BuildInfo buildInfo, bool debugLog = false)
        {
            if (buildInfo == null)
            {
