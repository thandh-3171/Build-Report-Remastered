...
namespace BuildReportRemastered
{
    ...
    {
        public static void CreateForUsedAssetsOnly(TextureData data, BuildReportRemastered.BuildInfo buildInfo, bool debugLog = false)
        {
            if (buildInfo == null)
            {
            ...
            BuildReportRemastered.BuildPlatform buildPlatform = BuildReportRemastered.ReportGenerator.GetBuildPlatformFromString(buildInfo.BuildType, buildInfo.BuildTargetUsed);
        ...
        public static void CreateForAllAssets(TextureData data, BuildReportRemastered.BuildInfo buildInfo, bool debugLog = false)
        {
            if (buildInfo == null)
            {
        ...
        static void AppendTextureData(TextureData data, BuildReportRemastered.BuildPlatform buildPlatform, IList<SizePart> assets, bool overwriteExistingEntries, bool debugLog = false)
        {
        ...
        static TextureData.Entry CreateEntry(string assetPath, string platform, bool debugLog = false)
        {
            ...
            if (textureImporter.npotScale == TextureImporterNPOTScale.None)
            {
                ...
                {
                    result.NPotScale = BuildReportRemastered.TextureData.NPOT_SCALE_NONE_IS_POT;
                }
                else
                {
                    result.NPotScale = BuildReportRemastered.TextureData.NPOT_SCALE_NONE_NOT_POT;
                }
            }
            else
            {
