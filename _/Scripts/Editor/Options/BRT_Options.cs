...
namespace BuildReportRemastered
{
    ...
    public class SavedOptions
    {
        ...
        public string BuildReportFolderName = BuildReportRemastered.Options.BUILD_REPORTS_DEFAULT_FOLDER_NAME;
    ...
    public static class Options
    {
        ...
        // =======================================================
        //
        static BuildReportRemastered.SavedOptions _savedOptions;
        ...
        {
            get { return string.Format("{0}ProjectSettings/{1}", BuildReportRemastered.Util.GetProjectPath(Application.dataPath), SAVED_OPTIONS_FILENAME); }
        }
        ...
        static void InitializeOptionsIfNeeded()
        {
            ...
            if (string.IsNullOrEmpty(_foundPathForSavedOptions))
            {
                ...
                {
                    _savedOptions = BuildReportRemastered.SavedOptions.Load(optionsInBuildReportFolder);
                ...
                {
                    _savedOptions = BuildReportRemastered.SavedOptions.Load(optionsInPluginsBuildReport);
                ...
                if (!IsBuildReportInRegularPaths)
                {
                    string customBuildReportFolder =
                        BuildReportRemastered.Util.FindAssetFolder(Application.dataPath, BUILD_REPORT_TOOL_DEFAULT_FOLDER_NAME);
                    if (!string.IsNullOrEmpty(customBuildReportFolder))
                    {
                        ...
                        {
                            _savedOptions = BuildReportRemastered.SavedOptions.Load(optionsInCustomBuildReportFolder);
                ...
                {
                    _savedOptions = BuildReportRemastered.SavedOptions.Load(optionsInTopmostAssets);
                ...
                var outsideAssets = BuildReportRemastered.Util.GetProjectPath(Application.dataPath);
                var optionsOutsideAssets = string.Format("{0}{1}", outsideAssets, SAVED_OPTIONS_FILENAME);
                if (File.Exists(optionsOutsideAssets))
                {
                    _savedOptions = BuildReportRemastered.SavedOptions.Load(optionsOutsideAssets);
                ...
                {
                    _savedOptions = BuildReportRemastered.SavedOptions.Load(optionsInProjectSettings);
                ...
                var optionsInMyDocs = string.Format("{0}/{1}/{2}", BuildReportRemastered.Util.GetUserHomeFolder(),
                ...
                {
                    _savedOptions = BuildReportRemastered.SavedOptions.Load(optionsInMyDocs);
            ...
            if (_savedOptions == null)
            {
                if (!string.IsNullOrEmpty(_foundPathForSavedOptions) && File.Exists(_foundPathForSavedOptions))
                {
                    ...
                    // just load that one
                    _savedOptions = BuildReportRemastered.SavedOptions.Load(_foundPathForSavedOptions);
                }
            }
            ...
            if (_savedOptions == null)
            {
                _savedOptions = new BuildReportRemastered.SavedOptions();
        ...
        public static string BuildReportSavePath
        {
            get
            {
                if (BuildReportRemastered.Options.SaveType == BuildReportRemastered.Options.SAVE_TYPE_PERSONAL)
                {
                    return string.Format("{0}/{1}", BuildReportRemastered.Util.GetUserHomeFolder(), BuildReportFolderName);
                }
                else
                {
                    ...
                    return string.Format("{0}/{1}", BuildReportRemastered.ReportGenerator.GetSavePathToProjectFolder(), BuildReportFolderName);
                }
            }
        }
