...
namespace BuildReportRemastered
{
    ...
    public class FileFilterGroup
    {
        ...
        {
            BuildReportRemastered.Options.FileFilterDisplay displayType = BuildReportRemastered.Options.GetOptionFileFilterDisplay();
            switch (displayType)
            {
                case BuildReportRemastered.Options.FileFilterDisplay.DropDown:
                    return DrawFiltersAsDropDown(assetList, width);
                case BuildReportRemastered.Options.FileFilterDisplay.Buttons:
        ...
        bool DrawFiltersAsDropDown(AssetList assetList, float width)
        {
            ...
            var topBarPopupStyle = GUI.skin.FindStyle(BuildReportRemastered.Window.Settings.FILE_FILTER_POPUP_STYLE_NAME);
