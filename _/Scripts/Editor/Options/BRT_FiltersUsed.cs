...
namespace BuildReportRemastered
{
    public class FiltersUsed
    {
        ...
        {
            return GetProperFileFilterGroupToUseFilePath(BuildReportRemastered.Options.BuildReportSavePath);
        }
        ...
        public static string GetProperFileFilterGroupToUseFilePath(string userFileFilterSavePath)
        {
            ...
            string fileFilterGroupAtDefaultAssetsPath =
                BuildReportRemastered.Options.BUILD_REPORT_TOOL_DEFAULT_PATH + "/" + FILE_FILTERS_USED_FILENAME;
            ...
            */
            ...
            string fileFilterGroupAtUserPersonalFolderDefaultName =
                BuildReportRemastered.Util.GetUserHomeFolder() + "/" + BuildReportRemastered.Options.BUILD_REPORTS_DEFAULT_FOLDER_NAME +
        ...
        {
            return GetProperFileFilterGroupToUse(BuildReportRemastered.Options.BuildReportSavePath);
        }
