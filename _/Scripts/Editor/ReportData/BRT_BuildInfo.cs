...
namespace BuildReportRemastered
{
    ...
    public partial class BuildInfo : BuildReportRemastered.IDataFile
    {
        // General Info
        // ==================================================================================
        ...
        public BuildReportRemastered.SizePart[] BuildSizes;
        ...
        /// </summary>
        public BuildReportRemastered.SizePart[] MonoDLLs;

        /// <summary>
        /// All managed DLL files from the project's Assets folder
        /// that were used in the build, and their file sizes.
        /// </summary>
        public BuildReportRemastered.SizePart[] ScriptDLLs;

        /// <summary>
        /// All the Unity API managed DLL files
        /// that were used in the build, and their file sizes.
        /// </summary>
        public BuildReportRemastered.SizePart[] UnityEngineDLLs;
