...
namespace BuildReportRemastered
{
    ...
    /// </summary>
    [System.Serializable]
    public class UnityBuildReport : BuildReportRemastered.IDataFile
    {
        /// <summary>
        ...
        {
            return BuildReportRemastered.Util.GetUnityBuildReportDefaultFilename(ProjectName, BuildType, TimeGot);
        }
    }
