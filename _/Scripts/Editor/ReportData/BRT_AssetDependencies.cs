...
namespace BuildReportRemastered
{
    ...
    public class AssetDependencies : BuildReportRemastered.IDataFile
    {
        /// <summary>
        ...
        {
            return BuildReportRemastered.Util.GetAssetDependenciesDefaultFilename(ProjectName, BuildType, TimeGot);
        }

        public string GetAccompanyingBuildReportFilename()
        {
            return BuildReportRemastered.Util.GetBuildInfoDefaultFilename(ProjectName, BuildType, TimeGot);
        }
