...
namespace BuildReportRemastered
{
    public static class Util
    {
        ...
        public static void SaveUnityBuildReportToCurrent(UnityEditor.Build.Reporting.BuildReport report)
        {
            ...
            string buildType;
            string gotBuildType = BuildReportRemastered.ReportGenerator.GetBuildTypeFromEditorLog(BuildReportRemastered.Util.UsedEditorLogPath);
            if (string.IsNullOrEmpty(gotBuildType))
            {
                var buildPlatform = BuildReportRemastered.ReportGenerator.GetBuildPlatformFromString(gotBuildType, EditorUserBuildSettings.activeBuildTarget);
            ...
            var br = new BuildReportRemastered.UnityBuildReport();
            br.ProjectName = BuildReportRemastered.Util.GetProjectName(Application.dataPath);
            br.BuildType = buildType;
            br.TimeGot = buildTimeStart;
            br.SetFrom(report);
            BuildReportRemastered.Util.SerializeAtFolder(br, BuildReportRemastered.Options.BuildReportSavePath);
        }
        ...
        public static void SaveUnityBuildReportToTemp(UnityEditor.Build.Reporting.BuildReport report)
        {
            ...
            br.SetFrom(report);
            br.OnBeforeSave();
            var x = new System.Xml.Serialization.XmlSerializer(typeof(BuildReportRemastered.UnityBuildReport));
        ...
        public static BuildReportRemastered.UnityBuildReport LoadUnityBuildReportFromTemp()
        {
            var savePath = string.Format("{0}{1}", System.IO.Path.GetTempPath(), "BR.txt");

            BuildReportRemastered.UnityBuildReport ret = null;
            ...
            try
            {
                ...
                using (var fs = new System.IO.FileStream(savePath, System.IO.FileMode.Open))
                {
                    ...
                    ret = (BuildReportRemastered.UnityBuildReport)x.Deserialize(reader);
                    fs.Close();
                }
            }
            catch (Exception e)
        ...
        public static void DebugLogBuildReport(BuildReportRemastered.UnityBuildReport report)
        {
            ...
            for (int i = 0; i < report.OutputFiles.Length; i++)
            {
                sb.AppendFormat("File {0}: {1} ({2}) {3}\n",
                    ...
                    BuildReportRemastered.Util.GetBytesReadable(report.OutputFiles[i].Size));
                if ((i + 1) % 100 == 0)
                {
        ...
        public static void DebugLogBuildReport(UnityEditor.Build.Reporting.BuildReport report)
        {
            ...
            for (int i = 0; i < report.files.Length; i++)
            {
                sb.AppendFormat("File {0}: {1} ({2}) {3}\n",
                    ...
                    BuildReportRemastered.Util.GetBytesReadable(report.files[i].size));
                if ((i + 1) % 100 == 0)
                {
                    Debug.Log(sb.ToString());
                    sb.Length = 0;
            ...
            sb.AppendFormat("Build Size: {0}", BuildReportRemastered.Util.GetBytesReadable(report.summary.totalSize));
        ...
        public static string GetBuildSizePathDescription(BuildInfo buildReport)
        {
            ...
            BuildReportRemastered.BuildPlatform buildPlatform =
                BuildReportRemastered.ReportGenerator.GetBuildPlatformFromString(buildReport.BuildType,
                ...
                buildPlatform == BuildPlatform.Linux64)
            {
                ...
                var dataFolder = BuildReportRemastered.Util.ReplaceFileType(exeFile, "_Data");
            ...
            if (buildPlatform == BuildPlatform.LinuxUniversal)
            {
                ...
                var exe64File = BuildReportRemastered.Util.ReplaceFileType(exe32File, ".x86_64");
                var dataFolder = BuildReportRemastered.Util.ReplaceFileType(exe32File, "_Data");
                var buildParentFolder = GetPathParentFolder(buildReport.BuildFilePath);
        ...
        public static string GetPackageFileContents(string filename)
        {
            ...
            string defaultBuildReportToolFullPath =
                Application.dataPath + "/" + BuildReportRemastered.Options.BUILD_REPORT_TOOL_DEFAULT_FOLDER_NAME;
            ...
            bool showRecoverableMsg)
        {
                ...
                progress))
            {
                ...
                if (deletedSoFar > 0)
                {
                    ...
                    {
                        cancelMsg += string.Format(" Those files can be recovered from your {0}.", BuildReportRemastered.Util.NameOfOSTrashFolder);
                    }
                }
                else
                {
        ...
        public static string UsedEditorLogPath
        {
            get
            {
                ...
                {
                    return BuildReportRemastered.Options.EditorLogOverridePath;
                }
        ...
        {
            get { return !string.IsNullOrEmpty(BuildReportRemastered.Options.EditorLogOverridePath); }
        }
        ...
        public static BuildReportRemastered.SizePart CreateSizePartFromFile(string filename, string fileFullPath,
            bool getRawSize = true)
        {
            var outPart = new BuildReportRemastered.SizePart();
            ...
            if (System.IO.File.Exists(fileFullPath))
            {
                ...
                outPart.ImportedSize = BuildReportRemastered.Util.GetBytesReadable(importedSizeBytes);
            }
            else
            {
                outPart.RawSizeBytes = -1;
        ...
        public static BuildReportRemastered.BuildInfo OpenSerializedBuildInfo(string serializedBuildInfoFilePath, bool fromMainThread = true)
        {
            ...
            BuildReportRemastered.BuildInfo ret = null;

            var x = new System.Xml.Serialization.XmlSerializer(typeof(BuildReportRemastered.BuildInfo));
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(correctedXmlData))
                {
                    ...
                    ret = (BuildReportRemastered.BuildInfo)x.Deserialize(reader);
                }
                else
                {
                    // no corrections in the xml file
        ...
        public static bool BuildInfoHasContents(BuildReportRemastered.BuildInfo n)
        {
        ...
        public static T OpenSerialized<T>(string filePath) where T : class, BuildReportRemastered.IDataFile
        {
            if (!System.IO.File.Exists(filePath))
            {
                return null;
        ...
        public static string SerializeAtFolder<T>(T data,
            string folderPathToSaveTo) where T : class, BuildReportRemastered.IDataFile
        {
            string filePath;
        ...
        public static void Serialize<T>(T data, string fullPathToSaveTo) where T : class, BuildReportRemastered.IDataFile
        {
